---
layout: post
title: "I'm probably going to launch a new cryptocurrency and blockchain in addition to status.health..."
...
- You get a tangible, real reward for verified healthy actions, not just a pat on the back. If you show up for regular testing or take other preventive action, you accrue value—not “points” that expire or can only be redeemed for branded swag.
- Missed a test? The system forgives you, up to a point. Streaks and bonuses decay gently, not instantly. Life happens, and the protocol recognizes that.
- The incentives are transparent and non-punitive. You can see exactly how rewards are calculated, and they’re designed so the most value accrues to those who are consistent, not those who can game the system.
- Points accrue for everyone, regardless of whether you know how to use a crypto wallet. If you want to stay in normie mode, fine—your rewards are just as real, and you can convert them to tokens whenever you want.
- No casino vibes. No “spin the wheel.” No loss aversion tricks. Just a persistent, steady nudge toward better habits.
...
- There are clear, metric-based thresholds for when governance hands off. These aren’t arbitrary. You’ll be able to see them, track progress, and know what’s coming.
- Governance isn’t just about voting on proposals. It’s about funding public goods, supporting integrations, and making sure the incentives stay aligned as the ecosystem evolves. Quadratic funding ensures that a lot of small contributors have more power than a few whales.
- If usage drops or the protocol gets gamed, decentralization slows or pauses. No “one-way door” to chaos. No DAO for the sake of optics.
- The rules, formulas, and transition points are all public. If you want to critique them, propose something better, or just follow along, you’ll have every tool you need.
- I’m committed to keeping the governance process as transparent as possible. You’ll know who’s making decisions, why they’re being made, and how to get involved if you care enough to show up.
- And, real talk: if nobody uses the thing, or if it turns into another DAO meme, I’d rather pull the plug than pretend it’s “community-led.” Governance is earned, not declared.
